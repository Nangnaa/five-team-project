...
<div class="container">
	<header>
		<div class="title">
			SHOPPING BAG
			<div class="title_quantity">(1)</div>
		</div>
	</header>
	<main>
		<div class="middlespace">
					...
					<div class="middlespace_left_content_west">
						...
						<div class="middlespace_left_info">
							...
							<div class="middlespace_left_info_option">
								<div>[옵션:베이지]</div>
								<div class="middlespace_left_info_optionmodify">변경</div>
							</div>
							<div class="middlespace_left_info_quantitybutton">
								<div class="quantity_button_number">10</div>
								<div class="quantity_button_minus">-</div>
								<div class="quantity_button_plus">+</div>
							</div>
						</div>
					</div>

					<div class="middlespace_left_content_east">
						<div class="middlespace_left_deletebutton">삭제</div>
					</div>
			...
			<div class="middlespace_right">
				...
				<div class="middlespace_right_buttons">
					<div class="button_allclear">쇼핑백비우기</div>
					<div class="button_specificclear">선택상품삭제</div>
					<div class="button_specificorder">선택상품주문</div>
					<div class="button_allorder">전체상품주문</div>
				</div>
				<div>
					<div>
						<strong>쇼핑백 이용안내</strong><br>
					</div>
					<div class="info">쇼핑백에 담긴 상품은 30일동안 보관됩니다. 보관된 상품은 30일 이후에
						삭제되오니 쇼핑백에서 삭제된 경우 다시 쇼핑백에 담아주시기 바랍니다.</div>
				</div>
			</div>
		</div>
	</main>

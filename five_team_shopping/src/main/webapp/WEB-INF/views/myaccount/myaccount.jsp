...
<jsp:include page="../include/index_include/index_header.jsp"></jsp:include>
    ...
    <div class="container">
        <div class="mypage-content">
            ...
            <div class="item_tf">
                <input type="text" class="item_box" id="user_id" placeholder="아이디">
            </div>
            <div class="item_tf">
                <input type="password" class="item_box"  placeholder="비밀번호">
            </div>
            <div class="item_msg">
            ...
            <div class="item_tf">
                <input type="text" class="item_box" id="user_name" placeholder="이름" >
            </div>
            <div class="item_add">
